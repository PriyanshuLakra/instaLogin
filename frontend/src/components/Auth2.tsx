    ...
    return <div className="h-screen bg-white flex flex-col items-center ">
        ...
        <form onSubmit={sendRequest}>
            ...
            <div className="w-3/7 h-3/7  flex flex-col items-center bg-white my-4 border border-solid border-gray-300 ">
                <img src={Images} alt="instagram" className="w-2/4 my-5" />
                ...
                <div>
                    ...
                    <p className="text-gray-500 dark:text-blue-900 my-8">Log in with faceBook</p>
                </div>
                <div>

                    <p className="font-semibold text-sm my-4 dark:text-blue-900">Forget Password ?</p>
                </div>
            </div>
        </form>
